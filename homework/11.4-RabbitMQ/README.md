...
Из-за другой версии pika пришлось немного поменять аргументы функции channel.basic_consume() в скрипте consumer.py и изменить код подключения, чтобы подключаться из-под созданного пользователя.
